...
public class SillyStrawItem extends ClamorCuisineItem {
	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.literal("ughhh... ffuuuck... this blood is").formatted(Formatting.GRAY));
		tooltip.add(Text.literal("so... fucking... yummy!!! mmmm!!!!").formatted(Formatting.GRAY));
		// not even sorry
	}
}
